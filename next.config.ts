...
const cspDirectives = [
  ...
  `script-src 'self' 'unsafe-inline' https://js.chargebee.com https://pulse.ciphera.net${process.env.NODE_ENV === 'development' ? " 'unsafe-eval'" : ''}`,
  ...
  "frame-src https://*.chargebee.com https://*.stripe.com",
  "object-src 'none'",
  "base-uri 'self'",
