...
const cspDirectives = [
  ...
  `script-src 'self' 'unsafe-inline' https://js.mollie.com https://pulse.ciphera.net${process.env.NODE_ENV === 'development' ? " 'unsafe-eval'" : ''}`,
  ...
  "font-src 'self'",
  `connect-src 'self' https://*.ciphera.net https://ciphera.net https://www.google.com https://*.gstatic.com https://cdn.jsdelivr.net https://*.mollie.com https://*.cartocdn.com${process.env.NODE_ENV === 'development' ? ' http://localhost:*' : ''}`,
