  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'grid min-w-[8rem] items-start gap-1.5 rounded-none border border-neutral-700 bg-neutral-800 px-2.5 py-1.5 text-xs',
          className,
        )}
      >
              ...
              >
                {itemConfig?.icon ? (
                  ...
                  !hideIndicator && (
                    <div
                      className={cn(
                        'shrink-0 rounded-none border-[var(--color-border)] bg-[var(--color-bg)]',
