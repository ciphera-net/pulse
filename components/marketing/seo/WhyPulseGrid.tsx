...
const DIFFERENTIATORS: Differentiator[] = [
  ...
  },
  {
    ...
    description:
      'The dashboard and tracking script are open (AGPL) on GitHub, and a real, no-login demo runs on our own site’s live traffic. You can verify every claim, not just take our word.',
    proof: { label: 'Open the live demo', href: '/demo' },
  },
]

const proofLinkClass =
  'mt-5 -mb-2.5 py-2.5 md:mb-0 md:py-0 inline-flex items-center gap-1 text-xs text-primary transition-colors duration-150 hover:text-primary/80 motion-reduce:transition-none'
