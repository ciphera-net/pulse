...
export function SeoPageCta({
  ...
  body = 'One script under 3 KB, no cookies to configure, no consent banner to build. Start on the free Personal tier, or explore the live demo on real traffic first — no signup required.',
}: {
  title?: string
  body?: string
}) {
