...
// every fact verified (free Personal tier per /pricing; under 3 KB, CI-enforced;
...
export function HomeClosingCta({
  ...
  dek = 'Paste one script tag under 3 KB and watch the first pageview arrive — free Personal tier included, no cookies to configure, nothing to consent to.',
