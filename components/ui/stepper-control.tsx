  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="p-3 md:p-1 rounded-none text-neutral-500 transition-colors duration-fast ease-apple hover:text-white disabled:pointer-events-none disabled:opacity-30"
      >
