import type { LifecycleDormantPayload, LifecycleFirstDataPayload, LifecycleInstallStalledPayload, LifecycleNoSitePayload, Receipt } from '@/lib/notifications/types'
