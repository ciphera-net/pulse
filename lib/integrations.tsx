...
export interface Integration extends InstallMeta {
  ...
  brandColor: string
  /** Black-only brand logo, rendered as a white fill on the dark tiles.
   *  (Never combine `fill-current` with `invert` — currentColor is already
   *  light here, so inverting it produced near-black glyphs on dark tiles.) */
...
const rawIntegrations: RawIntegration[] = [
  ...
  },
  {
    ...
    brandColor: '#2C4F7C',
    icon: (
      <svg role="img" viewBox="0 0 24 24" className="w-8 h-8" style={{ fill: '#76B3E1' }}>
