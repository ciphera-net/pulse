 ...
 * script ships 2.7 KB gzipped, under the 3 KB build budget).
 */
...
const pillars: Feature[] = [
  ...
  },
  {
    ...
    description:
      '2.7 KB gzipped — about 54× lighter than Google Analytics. Loads async with defer, so it never blocks rendering.',
