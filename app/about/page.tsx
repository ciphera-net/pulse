...
const companyReceipts: Receipt[] = [
  ...
  {
    title: 'A 2.7 KB script',
    description:
      'Measured, not rounded: 2.7 KB gzipped — about 54× lighter than Google Analytics. When it shrinks, this number changes.',
...
const vsLinks = [
  ...
  { slug: 'matomo', label: 'vs Matomo', description: 'Self-hosted heavyweight versus a 2.7 KB script.' },
    ...
    <>
      ...
      >
        ...
        <div className="mx-auto mt-12 w-full max-w-4xl">
          <MacWindow>
            <Image
              src={cdnUrl('/marketing/dashboard-hero-19-09-2026-2x.png')}
