...
const schemaFaqs = [
  ...
  { question: 'Can I export my data?', answer: "Yes. Export from the dashboard as CSV, JSON or Excel, or pull it through the public read API — both are included on every plan, the free Personal tier included." },
]
