      ...
      <div className="pt-8 pb-16">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-neutral-900 border border-neutral-800 text-white px-5 py-2.5 rounded-xl font-medium hover:bg-neutral-800 transition-all duration-base ease-apple"
          >
            Contact us
          </a>
        </motion.div>
