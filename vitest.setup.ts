...
// code in imported files (lib/env.ts, lib/api/client.ts, lib/mollie.ts, etc.)
// sees these env vars already set. Without this, the @t3-oss/env-nextjs Zod
// schema validation throws at module import and the entire test suite fails
// 1/0 before collection.
//
...
// All values are valid per the Zod schema (real URLs, pfl_ prefix on Mollie,
// enum-valid testmode) so createEnv() accepts them.
